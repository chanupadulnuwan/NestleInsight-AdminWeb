...
export default function TmSettingsPage() {
  ...
  return (
    <TerritoryManagerPortalShell
      user={user}
      breadcrumb="Territory Manager · Settings"
      title="Settings"
      description="Manage security for your account and move between your territory manager workspaces."
    >
      <section className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
        <article className={`${surfaceClass} px-6 py-6 sm:px-7`}>
          ...
          <p className="mt-3 text-sm leading-7 text-[#7f6657]">
            Use your current password plus a stronger replacement to keep the territory portal secure.
          </p>
        ...
        <article className={`${surfaceClass} px-6 py-6 sm:px-7`}>
          ...
          <div className="mt-5 grid gap-4">
            <button
              ...
              className="rounded-[1.35rem] border border-[#eee2d7] bg-[#fff9f5] px-4 py-4 text-left transition duration-300 hover:border-[#d2b8a4] hover:bg-[#fff6ef]"
            >
              <p className="text-sm font-semibold text-[#8a6c58]">Profile</p>
              <p className="mt-2 text-[1.25rem] font-bold text-[#4d3020]">Review account details</p>
            </button>
            <button
              type="button"
              onClick={() => navigate('/tm/warehouse')}
              className="rounded-[1.35rem] border border-[#eee2d7] bg-[#fff9f5] px-4 py-4 text-left transition duration-300 hover:border-[#d2b8a4] hover:bg-[#fff6ef]"
            >
              <p className="text-sm font-semibold text-[#8a6c58]">Warehouse</p>
              <p className="mt-2 text-[1.25rem] font-bold text-[#4d3020]">Open your warehouse desk</p>
            </button>
            <button
              type="button"
              onClick={() => void logout()}
            ...
            >
              ...
              <p className="mt-2 text-[1.25rem] font-bold text-[#4d3020]">Log out of the portal</p>
            </button>
          </div>
        </article>
      </section>
