...
export default function AdminProfilePage() {
  ...
  return (
    <AdminPortalShell
      ...
      title="Profile"
      description="Review your admin identity and account activation details."
    >
        ...
        <article className={`${surfaceClass} px-6 py-6 sm:px-7`}>
          ...
          <div className="mt-5 grid gap-4">
            <div className="rounded-[1.35rem] border border-[#eee2d7] bg-[#fff9f5] px-4 py-4">
              ...
              <p className="mt-2 text-[1.35rem] font-bold text-[#4d3020]">Administrator</p>
            </div>
            <div className="rounded-[1.35rem] border border-[#eee2d7] bg-[#fff9f5] px-4 py-4">
              <p className="text-sm font-semibold text-[#8a6c58]">Portal access</p>
              <p className="mt-2 text-[1.35rem] font-bold text-[#4d3020]">{user.platformAccess}</p>
            </div>
            <div className="rounded-[1.35rem] border border-[#eee2d7] bg-[#fff9f5] px-4 py-4">
              <p className="text-sm font-semibold text-[#8a6c58]">Account status</p>
              <p className="mt-2 text-[1.35rem] font-bold text-[#4d3020]">{user.accountStatus}</p>
            </div>
          </div>
        </article>
      </section>
